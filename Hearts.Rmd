...
# The result of this glht test gives a p-value of 0.186, suggesting that diabetes does not necessarily contribute to Tachycardia. Also, the resultant confidence interval of -0.013 to 0.035 contains 0. Thus we cannot declare that diabetes is a risk factor.
```
