...
plot(vario)
#variogram appears to be increasing, thus suggesting correlation in the residuals
```
...
ggplot(data = obs, aes(x = Lon, y = Lat, fill = resid(exp.mod))) + geom_raster() + scale_fill_distiller(palette = "Spectral", na.value = NA)
